...
export function useProducerApi(workspaceId: Ref<WorkspaceId>) {
  ...
  function deleteChannel(channelId: ChannelId): Promise<void> {
    return $fetch<undefined>(`${basePath.value}/channels/${channelId}`, { method: 'DELETE' })
  }
  ...
  function deleteLayer(channelId: ChannelId, layerId: LayerId): Promise<void> {
    return $fetch<undefined>(`${basePath.value}/channels/${channelId}/layers/${layerId}`, { method: 'DELETE' })
  }
  ...
  function deleteElement(channelId: ChannelId, elementId: ElementId): Promise<void> {
    return $fetch<undefined>(`${basePath.value}/channels/${channelId}/elements/${elementId}`, { method: 'DELETE' })
  }
  ...
  function deleteAsset(assetId: AssetId): Promise<void> {
    return $fetch<undefined>(`${basePath.value}/assets/${assetId}`, { method: 'DELETE' })
  }
